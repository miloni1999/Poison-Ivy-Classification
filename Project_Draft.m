...
%     rect = [160.5100   34.5100  547.9800  477.9800];
...
%     disp(cut_off_value);
    ...
    im_unsigned = uint16(im_strong_edges);
...
%     im_binarized = bwareaopen(im_binarized, 2000);
%     component = bwconncomp(im_binarized);
%     label = labelmatrix(component);
% 
%     for curr = 1:component.NumObjects
%         val = label == curr;
%         figure
%         imshow(val);
%     end
